...
import {HideRequest} from "../models/HideRequest";
...
deleteRequest: DeleteRequest,
    ...
    /**
     * hideRequest
     * @param hideRequest hideRequest
     * @returns BaseResponse_boolean_ OK
     * @returns any Created
     * @throws ApiError
     */
    public static hideQuestionUsingPost(
        hideRequest: HideRequest,
    ): CancelablePromise<BaseResponse_boolean_ | any> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/question/hide',
            body: hideRequest,
            errors: {
                401: `Unauthorized`,
                403: `Forbidden`,
     ...
     * @throws ApiError
     */
    public static unHideQuestionUsingPost(
        hideRequest: HideRequest,
    ): CancelablePromise<BaseResponse_boolean_ | any> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/question/display',
            body: hideRequest,
            errors: {
                401: `Unauthorized`,
                403: `Forbidden`,
